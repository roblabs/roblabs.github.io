...
<details markdown=1><summary>Details: How the Product Matrix image was built</summary>
* Built using <https://github.com/mermaid-js/mermaid>
...
* Resample=cubic
* Hash to a Zoom, Latitude, Longitude
</details>

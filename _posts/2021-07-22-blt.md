...
* A **3'x5' print map** using OpenStreetMap data + BLT Trail data + Satellite Imagery, built with the [QGIS Print Layout](https://docs.qgis.org/3.22/en/docs/training_manual/forestry/forest_maps.html#basic-fa-preparing-the-print-layout) engine.
  * A **20"x30" print map** for use at events, or to use for fundraising gifts for sponsors.
...
<div id="gallery">
  ...
  <div class="carousel-wrapper" style="height: 400px">
    ...
    >
      ...
      <figure>
        <figcaption>
          Build Lebanon Trails — Satellite only without any OpenStreetMap nor
          trails.
        </figcaption>
      </figure>
    </div>
    ...
    >
      ...
      <figure>
        <figcaption>
          Build Lebanon Trails — Unfiltered OpenStreetMap data.
        </figcaption>
      </figure>
    </div>
    <div
    ...
    >
      ...
      <figure>
        <figcaption>
          Build Lebanon Trails — Filtered OpenStreetMap data without trails.
        </figcaption>
      </figure>
    </div>
    <div
    ...
    >
      ...
      <figure>
        <figcaption>
          Build Lebanon Trails — What was shipped to the printer.
        </figcaption>
      </figure>
    </div>
  </div>
...
* This is a 2'x3' map that is print ready with dimensions of 7200 × 10800 pixels at 300 pixels per inch.
  ...
  * This  [53 MB Zipfile](https://github.com/roblabs/maps-for-non-profits/releases/download/v2021-11-02/Build-Lebanon-Trails-8x10.zip) contains five maps scaled at 8"x10" for use for printing on letter size pages.  See the 

...
The map was based on Apple Maps, interactive maps on the Web, which offers standard and satellite maps types.  While Apple Maps will work on most browsers for desktop and mobile, the customer may want to view the landmark in their favorite map app on their mobile phone.

...
* If you are interested in processing Geospatial PDFs, then we recommend the FOSS4G tool [GDAL](http://gdal.org).  Please see our technical note on using GDAL to process Geospatial PDFs at [RobLabs.com/gdal-geopdf](http://RobLabs.com/gdal-geopdf)
* This video gives an example of toggling layers in the El Capitan Quadrangle in Yosemite National Park using Adobe Acrobat Reader DC.

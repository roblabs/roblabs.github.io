...
GeoJSON.io was developed by Mapbox and is a *"A quick, simple tool for creating, viewing, and sharing spatial data."* 

It is a perfect way to visualize or test or learn how [GeoJSON](https://geojson.org/) data is created, formatted, styled or inspected.  We have made updates to GeoJSON.io, found at [RobLabs.com/geojson](https://RobLabs.com/geojson), which implements Public Domain styles.

---

#### Example Joshua Tree

1.  Say you want to visualize this GeoJSON:
...
2.  You can open a *Park Tiles*-specific version of GeoJSON.io — [RobLabs.com/geojson](https://RobLabs.com/geojson)
...
3.  Once your new browser window is open, then ppen your GeoJSON in the viewer
...
<img src="https://user-images.githubusercontent.com/118112/204346193-0b2bf8b8-a5a2-4dda-bee8-8ff3faf7949a.png" width="50%">

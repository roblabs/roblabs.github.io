...
#### Jan 23, 2023 — Weather from National Weather Service

Weather.gov APIs for alerts & weather.

<details open>

Weather.gov has public facing weather.   For example, at [Cabrillo National Monument](https://nps.gov/cabr) you can see the current weather, alerts and a forecast:

* https://forecast.weather.gov/MapClick.php?lon=-117.23965644836426&lat=32.674205348845035

A customer can use the map at forecast.weather.gov to adjust the location, and save a bookmark for future reference.
...
Withing the GeoJSON data response from `/points`, there is a property called `forecast`:

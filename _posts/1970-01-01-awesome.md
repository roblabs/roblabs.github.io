...
##### Solid color fill of Unicode Characters
...
* ![http://ipsumimage.appspot.com/10x10,f15625?l=+](http://ipsumimage.appspot.com/10x10,f15625?l=+) — Set a `dimension,hexCode` and alternatively annotate with `?l=text+and+use+plus+as+space`

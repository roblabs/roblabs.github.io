...
* `brew install awscli cocoapods ImageMagick jsonnet tippecanoe tree wget`
...
* [`pod`](https://cocoapods.org) - `brew install cocoapods`
...
* [tree](http://mama.indstate.edu/users/ice/tree/)  - `brew install tree` — `tree -f .` - Display directories as trees (with optional color/HTML output)
``` bash
tree -f . -L 1
.
├── ./Desktop
...
* [atom](http://atom.io)
  * `apm list`
  * `apm install atom-beautify atom-ide-terminal language-jsonnet markdown-image-assistant pretty-json`

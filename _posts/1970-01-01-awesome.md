...
* For use in JSON — `<a target='_blank' href='https://developer.mozilla.org/en-US/docs/Web/HTML/Element/a'>Mozilla MD</a>`
...
* Add these to `package.json`
  *   `"dependencies": { "minimist": "^1.0.0", "concat-stream": "^2.0.0" }`
* Usage:
